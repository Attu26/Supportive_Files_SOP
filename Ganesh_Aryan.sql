...
#1.	List Top 3 products based on QuantityAvailable. 
#(productid, productname, QuantityAvailable ). (3 Rows) [Note: Products].
...
SELECT pd.EmailId as Total_Transactions
...
Select c.CategoryName as Category_Name, p.QuantityAvailable as
...
#4.Display ProductId, ProductName, CategoryName, Total_Purchased_Quantity for the
#product which has been sold maximum in terms of quantity?
...
#(Round up to 2 decimal p	laces) Add “%” signwhile displaying the percentage. 
#(1 Row) [Note: users]

SELECT  
      Gender,
      count(Gender ='F') as female  from Users
where Gender = 'F';
...
#10. What is the 2nd most valuable item available which does not belong to the “Motor” 	
#category. Value of an item = Price * QuantityAvailable. Display ProductName, 	
